...
// 订单选项
const orderTypes = [
  { type: 1, text: '待分拣', icon: 'icon-currency' },
  { type: 2, text: '待收货', icon: 'icon-check' },
  { type: 3, text: '已完成', icon: 'icon-comment' },
]
</script>
...
<template>
  <scroll-view class="viewport" scroll-y="true" enable-back-to-top="true">
    ...
    <view class="profile">
      ...
      <view class="overview" v-if="userStore.profile._id">
        <navigator url="/pagesMember/profile/profile" hover-class="none">
          <image class="avatar" mode="aspectFill" :src="userStore.profile.avatarUrl"></image>
        </navigator>
        <view class="meta">
          <view class="nickname">
      ...
      <view class="overview" v-else>
        <navigator url="/pages/login/login" hover-class="none">
          <image class="avatar gray" mode="aspectFill" src="/static/logo.png"></image>
        </navigator>
        <view class="meta">
    ...
    <!-- 猜你喜欢 -->
    <view class="guess">
      <Products :needType="1" :productData="productStore.productList">
